...
- **Bahasa UI** — semua teks user-facing (label, placeholder, toast, button, error message) wajib dalam **English**. Termasuk dokumen resmi (QuotationPaper, InvoicePaper) — tidak ada pengecualian.
