...
} from "@/components/ui/alert-dialog" // Import Alert Delete
...
export default function ClientsPage() {
  ...
  const [deleteId, setDeleteId] = useState<string | null>(null) // State Delete
  ...
  const handleDeleteClick = (client: Client) => {
    setDeleteId(client.id); // Buka Dialog Konfirmasi
  }
  ...
  // 3. DEFINISI KOLOM (Menerima Edit & Delete)
  ...
  return (
    <div className="flex-1 space-y-4 p-8 pt-6">
      ...
      <div className="flex flex-col md:flex-row items-center justify-between gap-4">
        ...
        <Dialog open={open} onOpenChange={setOpen}>
            ...
            <DialogContent className="sm:max-w-[500px]">
                ...
                {/* KEY PROP PENTING: Agar form reset saat switch mode */}
                <ClientForm 
      ...
      {/* SEARCH BAR */}
      <div className="flex items-center space-x-2 bg-white p-1 rounded-md border w-full md:w-[400px]">
