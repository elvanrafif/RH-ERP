          ...
          <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
            ...
            <Card>
              ...
              <CardContent>
                <div className="text-2xl font-bold">
                  ...
                  {isLoading ? "Loading..." : formatRupiah(data?.totalOmzet || 0)}
                </div>
                <p className="text-xs text-muted-foreground">Data Realtime Database</p>
              </CardContent>
            </Card>
            ...
            <Card>
              ...
              <CardContent>
                ...
                <p className="text-xs text-muted-foreground">Total Project Terdaftar</p>
              </CardContent>
            </Card>
            ...
            {/* ... Kartu sisa biarkan hardcoded ... */}
             <Card>
              ...
              <CardContent>
                ...
                <p className="text-xs text-muted-foreground">Hardcoded (Next Task)</p>
              </CardContent>
            </Card>
