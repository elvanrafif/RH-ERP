...
import { INVOICE_STATUS } from '@/lib/constant'
import type {
  InvoiceReportRow,
  QuotationReportRow,
              ...
              <tbody>
                {invoiceRows.length === 0 ? (
                  ...
                  invoiceRows.map((row) => (
                    <tr
                      key={row.id}
                      className="border-t border-border/60 hover:bg-slate-50/50"
                    >
