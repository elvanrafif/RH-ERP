...
export default function ProfilePage() {
    ...
    if (isLoading || !user) return <div className="flex h-full items-center justify-center"><Loader2 className="animate-spin text-muted-foreground" /></div>;

    return (
        <div className="p-4 md:p-8 max-w-5xl mx-auto">
            <h1 className="text-2xl font-bold tracking-tight mb-6">Pengaturan Akun</h1>
                    ...
                    <Card className="overflow-hidden">
                        ...
                        <CardContent className="pt-0 -mt-12 flex flex-col items-center text-center relative z-10">
                            ...
                            <div className="flex flex-wrap justify-center gap-2">
                                <Badge variant="outline" className={`uppercase ${getDivisionBadge(user.division)}`}>
                                    {user.division || "Umum"}
                                </Badge>
